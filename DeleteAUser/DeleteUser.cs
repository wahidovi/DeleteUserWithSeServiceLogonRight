...
namespace DeleteAUser
{
    internal class DeleteUser
    {
        ...
        public static void DeleteServiceUser(string s)
        {
            string username = s; //username you want to delete
            ...
            try
            {
                using (PrincipalContext pc = new PrincipalContext(ContextType.Machine))
                {
                    ...
                    if (existingUser != null)  // Delete the user if it exists
                    {
                       
                        //RemoveRight will remove the user from SeServiceLogonRight (Log on as Service Policy)
